...
const CodingList = () => {
    ...
    const topics = [
        ...
        },
        {
            ...
            lessons: 15,
            students: 2890,
            description: 'Master JavaScript basics including variables, functions, and loops',
        ...
        },
        {
            ...
            lessons: 13,
            students: 1987,
            description: 'Learn database design, SQL queries, and data management',
            icon: <Storage fontSize="small" />,
            status: 'Popular',
            tags: ['Intermediate', 'SQL', 'Database'],
            slug: 'sql-databases',
        },
        {
            id: 7,
        ...
        },
        {
            ...
            status: 'Trending',
            tags: ['Advanced', 'Mobile', 'React Native'],
        ...
        },
        {
            ...
            lessons: 12,
            students: 1456,
            description: 'Learn security best practices, encryption, and threat prevention',
            icon: <Security fontSize="small" />,
            status: 'New',
            tags: ['Intermediate', 'Security', 'Ethical Hacking'],
        ...
        },
        {
            ...
            lessons: 9,
            students: 2678,
            description: 'Master Git commands and version control for collaborative coding',
        ...
        },
        {
            ...
            lessons: 14,
            students: 1678,
            description: 'Learn TypeScript types, interfaces, and advanced features',
            icon: <Code fontSize="small" />,
            status: 'Trending',
            tags: ['Intermediate', 'TypeScript', 'Frontend'],
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p className={cn(
                            ...
                            Learn programming languages, frameworks, and development skills
                        </p>
                    </div>
                    <ParticleButton
                        type="button"
